    ...
    return(
        ...
        <section className="hero-section">
            <div className="hero-container">
                ...
                <p className='fw-bold'>World Robotics & Computer Science Olympiad registration is closed !
                     <br /> thank you for the interest, we will inform you when the registration is opened !
                </p>
                 <br />
                ...
                <a href="/homeregist" className="registration-button fw-bold">Coming Soon !</a>
