...
const Navigation = () =>{
    ...
    return(
        <>
        <header>
            <a href="/"><img className='logo-nav' src="./assets/images/logo/WRCSO.png" alt="" /></a>
            <div className='navigation'>
                <ul className='menu'>
                    ...
                    <li className='menu-item fw-bold'><a href="https://drive.google.com/file/d/17BRH044yxVmwSZD-otAJX1TUvbMI9F5W/view?usp=sharing" target='_blank'>Guide Book</a></li>
                    ...
                    <li className='menu-item fw-bold'><a href="/Faqs">Faq</a></li>
                     <li className='menu-item fw-bold'><a href="/Contacts">Contact</a></li>
                </ul>
            </div>
